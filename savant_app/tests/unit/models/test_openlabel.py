...
class TestOpenLabel:
                        ...
                        "objects": {
                            "1": {
                                "object_data": {
                                    "rbbox": [{
                                        "name": "shape",
                                        "val": [3594.0, 1159.0, 125.0, 67.0, 0.0019]
                                    }],
                                    "vec": [{
                                        "name": "confidence",
                            ...
                            "2": {
                                "object_data": {
                                    "rbbox": [{
                                        "name": "shape",
                                        "val": [3678.0, 1031.0, 134.0, 70.0, 0.0016]
                                    }],
                                    "vec": [{
                                        "name": "confidence", 
                        ...
                        "objects": {
                            ...
                            "2": {
                                "object_data": {
                                    "rbbox": [{
                                        "name": "shape",
                                        "val": [3664.0, 1031.0, 135.0, 69.0, 0.0012]
                                    }],
                                    "vec": [{
                                        "name": "confidence",
    ...
    def test_invalid_confidence_value(self):
        ...
        invalid_data = self.expected_output["openlabel"].copy()
        invalid_data["frames"]["0"]["objects"]["1"]["object_data"]["vec"][0]["val"] = [1.1]
        with pytest.raises(ValidationError):
            OpenLabel(**invalid_data)
