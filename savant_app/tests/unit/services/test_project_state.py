...
class TestProjectState:
    ...
    def setup_method(self):
        ...
        self.test_config_path = str(Path(__file__).parent.parent.parent / "assets" / "Kraklanda_short.json")
    ...
    def test_load_config(self):
        ...
        test_config_path = str(Path(__file__).parent.parent.parent / "assets" / "Kraklanda_short.json")
        ...
        # Pydantic model instances can be compared with == operator.
        assert expected_result == project_state.annotation_config
