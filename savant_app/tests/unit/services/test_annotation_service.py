...
class TestAnnotationService:
    ...
    def test_add_new_object_calls_config(self, annotation_service, mock_project_state):
        ...
        mock_project_state.annotation_config.add_new_object.assert_called_once_with(obj_type=obj_type)

    @pytest.mark.parametrize("frame_number, bbox_info", [
    ...
    def test_add_new_object_bbox_valid_input(
        ...
        call_args = mock_project_state.annotation_config.append_new_object_bbox.call_args[1]
