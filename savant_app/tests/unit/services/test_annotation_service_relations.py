...
def test_get_object_relationships(mock_project_state):
    ...
    mock_project_state.annotation_config.get_object_relationships.return_value = relations

    result = annotation_service.get_object_relationships("1")
    assert result == relations
    mock_project_state.annotation_config.get_object_relationships.assert_called_once_with("1")
...
def test_delete_relationship(mock_project_state):
    ...
    mock_project_state.annotation_config.delete_relationship.assert_called_once_with("1")
