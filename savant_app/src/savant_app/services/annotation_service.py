...
class AnnotationService:
    ...
    def add_new_object_bbox(self, frame_number: int, bbox_info: dict) -> None:
        ...
        self.project_state.annotation_config.append_new_object_bbox(frame_id=frame_number, bbox_info=bbox_info, confidence_data=confidence_data, annotater_data=annotater_data)
