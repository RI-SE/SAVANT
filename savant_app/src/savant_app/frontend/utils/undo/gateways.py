...
class AnnotationGateway(Protocol):
    ...
    def delete_object_relationship(self, relation_id: str) -> None: ...
...
class ControllerAnnotationGateway:
    ...
    def delete_object_relationship(self, relation_id: str) -> None:
        self.annotation_controller.delete_relationship(relation_id)
    ...
    def restore_object_relationship(
        ...
        self.annotation_controller.restore_object_relationship(
            relation_id,
            relationship_type,
            ontology_uid,
            subject_object_id,
