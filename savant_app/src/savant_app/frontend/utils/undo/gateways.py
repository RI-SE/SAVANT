...
class AnnotationGateway(Protocol):
    ...
    def delete_relationship(self, relation_id: str) -> None: ...
...
class ControllerAnnotationGateway:
    ...
    def create_object_relationship(
        ...
        """
        Create the relationship through the controller and return the actual ID
        """
        relation_id = self.annotation_controller.add_object_relationship(
            relationship_type,
            ontology_uid,
            subject_object_id,
            object_object_id,
    ...
    def delete_relationship(self, relation_id: str):
        return self.annotation_controller.delete_relationship(relation_id)
    ...
    def restore_relationship(
        ...
        subject_object_id: str,
        object_object_id: str,
        ontology_uid: str = "1.3.0",  # TODO: Remove once ticket implemented
    ) -> None:
        # For restore, we just recreate the relationship
        # Note: The relationship name will be auto-generated by the model
        self.annotation_controller.restore_relationship(
            relation_id,
            relationship_type,
            ontology_uid,
            subject_object_id,
