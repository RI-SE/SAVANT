...
Once the installation is complete, you can launch the app from within the `savant_app` directory.
...
*   The application writes logs to a `savant_app.log` file in the `savant_app` directory and to a system-specific log directory.
