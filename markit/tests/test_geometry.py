...
class TestBBoxOverlapCalculator:
    ...
    def test_non_overlapping_bboxes_return_iou_zero(self):
        ...
        bbox1 = np.array([[0.0, 0.0], [10.0, 0.0], [10.0, 10.0], [0.0, 10.0]])
        bbox2 = np.array([[20.0, 20.0], [30.0, 20.0], [30.0, 30.0], [20.0, 30.0]])
    ...
    def test_half_overlapping_bboxes(self):
        ...
        bbox1 = np.array([[0.0, 0.0], [20.0, 0.0], [20.0, 10.0], [0.0, 10.0]])
        bbox2 = np.array([[10.0, 0.0], [30.0, 0.0], [30.0, 10.0], [10.0, 10.0]])
        iou = BBoxOverlapCalculator.calculate_intersection_over_union(bbox1, bbox2)
    ...
    def test_nested_bbox_smaller_inside_larger(self):
        ...
        bbox_large = np.array([[0.0, 0.0], [100.0, 0.0], [100.0, 100.0], [0.0, 100.0]])
        bbox_small = np.array([[25.0, 25.0], [75.0, 25.0], [75.0, 75.0], [25.0, 75.0]])
        iou = BBoxOverlapCalculator.calculate_intersection_over_union(
    ...
    def test_rotated_bbox_partial_overlap(self):
        ...
        # Calculate half diagonal for rotated square
    ...
    def test_polygon_area_rectangle(self):
        ...
        rectangle = np.array([[0.0, 0.0], [20.0, 0.0], [20.0, 5.0], [0.0, 5.0]])
    ...
    def test_invalid_bbox_format_returns_zero(self):
        ...
        bbox2 = np.array([[0.0, 0.0], [10.0, 0.0], [10.0, 10.0], [0.0, 10.0]])
        iou = BBoxOverlapCalculator.calculate_intersection_over_union(bbox1, bbox2)
        assert iou == 0.0
    ...
    def test_sutherland_hodgman_clip_complete_overlap(self):
        ...
        subject = np.array([[2.0, 2.0], [8.0, 2.0], [8.0, 8.0], [2.0, 8.0]])
        clip = np.array([[0.0, 0.0], [10.0, 0.0], [10.0, 10.0], [0.0, 10.0]])
    ...
    def test_sutherland_hodgman_clip_no_overlap(self):
        ...
        subject = np.array([[0.0, 0.0], [5.0, 0.0], [5.0, 5.0], [0.0, 5.0]])
        clip = np.array([[10.0, 10.0], [20.0, 10.0], [20.0, 20.0], [10.0, 20.0]])
        result = BBoxOverlapCalculator._sutherland_hodgman_clip(subject, clip)
