"""
Version utilities for SAVANT toolkit.

Provides a single source of truth for version information by reading
from pyproject.toml or package metadata.
"""
...
@lru_cache(maxsize=1)
def get_version() -> str:
    """Return the SAVANT version string.

    Tries to get the version from:
    1. Package metadata (if installed)
